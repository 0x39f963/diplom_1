...
Карты механизмов с алгоритмом «было / стало» и примером JSON на каждом шаге:

- [Связь задает цель](images/mech-relation-target.svg) - связь фрейма переопределяет целевую сущность.
- [Команда против инъекции](images/mech-guard-split.svg) - вердикт охраны на read-команду и на попытку взлома.
- [Уточнение только по делу](images/mech-clarify.svg) - лишний переспрос превращается в собранный план.
- [Поиск как шаг разрешения](images/mech-search-resolver.svg) - поиск дает id и кормит следующий шаг.
- [Закон добавляется к данным](images/mech-additive-legal.svg) - норма входит в общий план по данным.
- [Проверка покрытия](images/mech-coverage.svg) - обязательные атомы запроса и слепок покрытия плана.
